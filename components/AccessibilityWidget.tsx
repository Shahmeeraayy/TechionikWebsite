...
import { setTheme, getCurrentTheme, initializeTheme } from "@/utils/theme";
...
export const AccessibilityWidget: React.FC = () => {
  ...
  return (
    <>
      ...
      <button
        ref={buttonRef}
        className="fixed bottom-24 right-5 w-14 h-14 rounded-full bg-dark-gradient border-none cursor-pointer flex items-center justify-center shadow-lg hover:shadow-xl hover:-translate-y-0.5 active:translate-y-0 transition-all duration-300 z-1000"
      ...
      >
        {/* Header */}
        <div className="bg-primary-dark text-white p-5 rounded-t-xl">
          ...
          <div className="flex gap-2 flex-wrap">
            <button
              className="py-1.5 px-3 bg-white/20 border border-white/30 rounded-md text-white text-xs cursor-pointer transition-all hover:bg-white/30 flex items-center gap-1.5"
        ...
        <div className="p-5">
          ...
          <div className="mb-6">
            ...
            {/* Dark Mode */}
            <div
              className={`flex items-center gap-2.5 text-sm text-gray-600 cursor-pointer select-none p-2 rounded-md transition-all ${currentTheme === "dark" ? "border-2 border-blue-500 bg-blue-50" : "border-2 border-transparent hover:border-gray-300"}`}
            ...
            {/* Light Mode */}
            <div
              className={`flex items-center gap-2.5 text-sm text-gray-600 cursor-pointer select-none p-2 rounded-md transition-all ${currentTheme === "light" ? "border-2 border-blue-500 bg-blue-50" : "border-2 border-transparent hover:border-gray-300"}`}
            ...
            {/* High Contrast */}
            {/* <div
              className={`flex items-center gap-2.5 text-sm text-gray-600 cursor-pointer select-none p-2 rounded-md transition-all ${settings.highContrast ? "border-2 border-blue-500 bg-blue-50" : "border-2 border-transparent hover:border-gray-300"}`}
            ...
            >
              <Contrast className="w-4.5 h-4.5 text-gray-500" />
              High Contrast
            </div> */}
          </div>
