...
export const  ChooseTechionikData: SoftwareSolutions = {
  title: "Why Choose TECHIONIK for",
  middleTitle: " Next.js ",
  lastTitle: "Development?",
  description:
    "Maximize the potential of Next.js with TECHIONIK—delivering performance, scalability, and innovation for top-tier web applications.",
  ...
  items: [
          {
            ...
            description:
              "<ul> <li>We develop enterprise applications that integrate business </li><li>We develop enterprise applications that integrate business </li><li>We develop enterprise applications that integrate business </li></ul>",
