...
export const mobileAppConsultingTechStackData: TechStackData = {
  headingData: {
    ...
    description:
      "Our consultants deliver enterprise-grade backend systems using Node.js, Python, Java, AWS, Azure, and GCP. Using microservices, REST and GraphQL APIs, and high-availability frameworks, we enable secure, low-latency, live data handling that drives business efficiency.",
  },
...
export const mobileAppConsultingPageData = {
  ...
  meta: {
    ...
    description:
      "Techionik provides end-to-end mobile app consulting services covering market positioning, app architecture, functionality, development process, audits, testing, budget planning, and monetization strategies for native, cross-platform, hybrid, and PWA solutions.",
    keywords: [
  ...
  heroSlides: [
    {
      ...
      subtitle:
        "Strategy, architecture, and launch guidance for iOS, Android, cross-platform, hybrid, and PWA products.",
      description:
    ...
    cards: [
      {
        ...
        description: [
          "Our dedicated mobile app developers create fully functional apps on iOS, Android, and cross-platform frameworks using mobile programming languages like Swift, Kotlin, Java, and HTML5.",
          "This helps solve performance, security, and maintenance challenges for your business before they slow delivery.",
        ],
      ...
      },
      {
        ...
        description: [
          ...
          "We integrate REST and GraphQL APIs, test across devices, reduce code duplication, and keep the architecture secure, maintainable, and cost efficient.",
        ],
      ...
      },
      {
        ...
        description: [
          ...
          "The result is stronger runtime performance, secure API gateways, better UX, and maintainable code that supports fast expansion and market relevance.",
        ],
      ...
      },
      {
        ...
        description: [
          "We offer end-to-end mobile app launch consulting, including feasibility analysis, market research, architecture and technology selection, UX and UI design, feature integration, cost estimation, and project scoping.",
          "This helps teams ship optimized, market-ready apps aligned with business goals.",
        ],
      ...
      },
      {
        ...
        description: [
          "We audit mobile apps' UI/UX, code quality, system architecture, security, compliance, and device and platform compatibility.",
          "You receive gap analysis, performance optimization, actionable improvements, and technical recommendations that improve user retention, security, and app quality.",
        ],
      ...
      },
      {
        ...
        description: [
          ...
          "This enables real-time synchronization, low-latency workflows, secure operations, and measurable efficiency improvements across your infrastructure.",
        ],
    ...
    cards: [
      {
        ...
        description:
          "With 4+ years and 200+ projects, our top 3% engineers design scalable apps for iOS, Android, and cross-platform frameworks such as Flutter, React Native, Swift, Kotlin, and Java. We optimize API integration, offline-first architecture, and backend connectivity, reducing load times by up to 40%, improving API response times by 35%, and supporting 500k+ concurrent users.",
      ...
      },
      {
        ...
        description:
          "We provide advisory across the app lifecycle, architecture design, modular codebase planning, UI and UX evaluation, automated testing, deployment, and post-launch optimization. Agile and Scrum practices help keep apps maintainable, event-driven, and aligned with microservices workflows.",
        icon: "/icons/coding.svg",
      },
      {
        id: 3,
        ...
        description:
          "We guide encryption, token-based authentication, multi-factor login, threat mitigation, and vulnerability handling such as SQL injection, XSS, and CSRF. Compliance spans GDPR and ISO 9001, 27001, 20000, 14001, 45001, and 22301, delivering audit-ready, enterprise-grade mobile apps that reduce operational risk.",
      ...
      },
      {
        ...
        description:
          "Our consulting ensures apps leverage cloud-native services, reusable components, automated pipelines, microservices, event-driven architecture, AI-assisted predictive caching, and analytics integration. We optimize push notification scaling, serverless functions, and real-time workflows for high-performance, maintainable, enterprise-ready solutions.",
        icon: "/icons/cloud.svg",
      },
      {
        id: 5,
        ...
        description:
          "Dedicated consultants, senior architects, DevOps engineers, QA specialists, and business analysts manage strategy, risk mitigation, KPI tracking, IP ownership, and structured reporting. Real-time dashboards and automated alerts support informed decisions and measurable business impact.",
      ...
      },
      {
        ...
        description:
          "Our team includes mobile architects, backend engineers, DevOps specialists, QA engineers, and business analysts. We support modern frameworks such as Flutter, React Native, Swift, Kotlin, and Java, as well as legacy platforms, enabling end-to-end mobile app integration and strategy execution.",
  ...
  faq: {
    ...
    faq: [
      ...
      },
      {
        ...
        answer:
          "Costs depend on the depth of consulting, such as architecture redesign, performance optimization, code review, modernization, or full lifecycle advisory. Pricing reflects consultant expertise, time required for technical analysis, documentation effort, and scope of work. Most engagements include architecture review, code audit, API evaluation, tech stack selection, and optimization planning. You can request a quick estimate based on your app's current complexity.",
      },
      {
        id: 5,
  ...
  whatWeDo: {
    ...
    card: [
      ...
      },
      {
        ...
        description:
          "<p>We design resilient app strategy, modular architecture, microservices patterns, and workflow mapping. Team assignments and milestones ensure efficient front-end and back-end integration, operational efficiency, and measurable ROI.</p>",
      },
      {
        id: 3,
        title: "UX, UI & API Strategy",
        description:
          "<p>We create wireframes, prototypes, and interaction flows. APIs follow REST, GraphQL, or event-driven patterns, with authentication, caching, rate limiting, and third-party integrations for real-time, secure connectivity.</p>",
      },
      {
        id: 4,
        title: "Core Technical Blueprinting",
        description:
          "<p>We define modular architecture, offline-first design, client-server patterns, analytics integration, messaging, and payment gateways. Apps are enterprise-ready, resilient, and high-performance.</p>",
      },
      {
        id: 5,
      ...
      },
      {
        ...
        description:
          "<p>We provide deployment guidance, front-end integration, real-time monitoring, query optimization, code refactoring, and third-party service management. Continuous improvements maximize resilience, performance, security, and long-term growth potential.</p>",
      },
    ],
  } satisfies WhatWeDo,
  industries: {
